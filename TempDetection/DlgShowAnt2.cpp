...
{
	switch (LastAlarmStatus[IntUSR-1][1][0])
	{
	case 0:
		m_CtlTChart01.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][0]);
		m_CtlTChart01.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart01.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][0]);
		m_CtlPowerChart01.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart01.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][0]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][1])
	{
	case 0:
		m_CtlTChart02.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][1]);
		m_CtlTChart02.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart02.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][1]);
		m_CtlPowerChart02.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart02.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][1]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][2])
	{
	case 0:
		m_CtlTChart03.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][2]);
		m_CtlTChart03.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart03.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][2]);
		m_CtlPowerChart03.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart03.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][2]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][3])
	{
	case 0:
		m_CtlTChart04.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][3]);
		m_CtlTChart04.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart04.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][3]);
		m_CtlPowerChart04.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart04.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][3]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][4])
	{
	case 0:
		m_CtlTChart05.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][4]);
		m_CtlTChart05.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart05.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][4]);
		m_CtlPowerChart05.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart05.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][4]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][5])
	{
	case 0:
		m_CtlTChart06.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][5]);
		m_CtlTChart06.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart06.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][5]);
		m_CtlPowerChart06.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart06.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][5]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][6])
	{
	case 0:
		m_CtlTChart07.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][6]);
		m_CtlTChart07.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart07.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][6]);
		m_CtlPowerChart07.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart07.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][6]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][7])
	{
	case 0:
		m_CtlTChart08.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][7]);
		m_CtlTChart08.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart08.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][7]);
		m_CtlPowerChart08.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart08.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][7]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][8])
	{
	case 0:
		m_CtlTChart09.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][8]);
		m_CtlTChart09.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart09.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][8]);
		m_CtlPowerChart09.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart09.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][8]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][9])
	{
	case 0:
		m_CtlTChart10.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][9]);
		m_CtlTChart10.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart10.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][9]);
		m_CtlPowerChart10.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart10.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][9]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][10])
	{
	case 0:
		m_CtlTChart11.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][10]);
		m_CtlTChart11.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart11.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][10]);
		m_CtlPowerChart11.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart11.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][10]);
	...
	switch (LastAlarmStatus[IntUSR-1][1][11])
	{
	case 0:
		m_CtlTChart12.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][11]);
		m_CtlTChart12.Series(0).GetAsNumericGauge().GetValueMarker().GetShape().GetFont().SetColor(RGB(0,0,255));
		m_CtlPowerChart12.Series(0).GetAsLinearGauge().SetValue(LastRecvPower[IntUSR-1][1][11]);
		m_CtlPowerChart12.Series(0).GetAsLinearGauge().GetRedLine().SetVisible(FALSE);
		break;
	case 1:
		m_CtlTChart12.Series(0).GetAsNumericGauge().SetValue(LastRecvTemp[IntUSR-1][1][11]);
