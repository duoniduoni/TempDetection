...
unsigned char SendFreqCMD[15]    ={0x00,0x46,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
unsigned char RecvFreqCMD[15]    ={0x00,0x47,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
...
void CDlgFactorySet::OnBnClickedButtonSendFreq()
{
	...
	long freqData = atol(strFreq);
	if ((freqData<=429000000)||(freqData>=452000000))
	{
		AfxMessageBox("请输入正确的频率值！频率值范围为429000000~452000000");
	}else
	{
...
void CDlgFactorySet::OnBnClickedButtonReceiveFreq()
{
	...
	{
		RecvFreqCMD[0]=(char)(nIndexReaderRecv+1);
...
void CDlgFactorySet::OnBnClickedButtonSaveLoopTime()
{
	...
	intUST=atoi(temp);
	WritePrivateProfileString("LOOPTIME","Time",temp,strFN);
}
...
void CDlgFactorySet::OnBnClickedButtonSaveSynchronous()
{
	...
	USSYN=nIndexSynchronous;
	WritePrivateProfileString("SYNCHRONOUS","Set",temp,strFN);
}
